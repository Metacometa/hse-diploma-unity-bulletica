...
public class DozerBull : Boss
{
    ...
    protected override void FixedUpdate()
    {
        ...
        switch (motionState)
        {
            ...
            case MotionState.Follow:
                dozerMove.Pursue(target.position());
                rotator.Rotate(dozerMove.GetMoveDir());
                rotator.RotateGun(dozerMove.GetMoveDir());
                break;
    ...
    {
        if (dozerMove.onPosition)
        {
            motionState = MotionState.Stay;
        }
        else if (target.inShootingRange && breakthrough.IsAttackPossible())
        {
